    ...
    <div className="af-page-container">
      ...
      <div className="af-card">
        <div className="sp-header">
          ...
          <p style={{ marginTop: '8px', color: '#475569', fontSize: '14px', lineHeight: 1.4 }}>
            <strong>Note:</strong> You may have only one active application at a time. If your application is not
            accepted, you may re-apply after one month.
          </p>
        </div>
