...
const Reports = () => {
  ...
  const requestParams = useMemo(() => {
    ...
    return params;
  }, [reportType, month, year, branch, currentQuarter]);
    ...
    <div className="reports-container">
      <div className="reports-header-section">
        <div className="header-with-icon">
          <div className="title-icon-box">RP</div>
      ...
      <div className="config-card">
        <div className="card-header-row">
          <span className="calendar-icon">RC</span>
        ...
        <div className="config-form">
          ...
          <div className="config-group">
            <label>Branch</label>
            <select className="config-select" value={branch} onChange={(e) => setBranch(e.target.value)}>
          ...
          <>
            ...
            <div className="success-rate-section">
              <div className="success-main-display">
                <div className="trend-icon">TR</div>
