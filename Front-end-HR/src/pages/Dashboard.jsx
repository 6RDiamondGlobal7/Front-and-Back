...
const Dashboard = ({ onLogout, user }) => {
  ...
  const displayName = String(user?.name || '').trim() || String(user?.id || '').trim() || 'HR User';
  const displayRole = String(user?.role || '').trim() || 'HR Manager';
  const badgeText = getUserBadge(displayRole);
      ...
      <div className="main-section">
        <header className="dashboard-header">
          ...
          <div className="user-info">
            ...
            <div className="user-badge">{badgeText}</div>
          </div>
        </header>
